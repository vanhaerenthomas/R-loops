...
location = "E:\\Work\\UPO Sevilla\\Doctorate_3_DROP_3T3_E14"
matrices = "\\matrices\\"
output = "\\output\\"

loc_3T3_neg = location + matrices + "\\DRIP_3T3_neg.csv"
loc_3T3_pos = location + matrices + "\\DRIP_3T3_pos.csv"

loc_E14_neg = location + matrices + "\\DRIP_E14_neg.csv"
loc_E14_pos = location + matrices + "\\DRIP_E14_pos.csv"

df_3T3_neg = pd.read_csv(loc_3T3_neg, sep='\t').head(10)
df_3T3_pos = pd.read_csv(loc_3T3_pos, sep='\t').head(10)

df_E14_neg = pd.read_csv(loc_E14_neg, sep='\t').head(10)
df_E14_pos = pd.read_csv(loc_E14_pos, sep='\t').head(10)
...
df_3T3 = pd.concat([df_3T3_neg, df_3T3_pos])
df_E14 = pd.concat([df_E14_neg, df_E14_pos])

X_train_3T3, X_test_3T3  = train_test_split(df_3T3, test_size=0.3, shuffle=True)
X_train_E14, X_test_E14 = train_test_split(df_E14, test_size=0.3, shuffle=True)

df_3T3_GROseq = df_3T3.drop(columns=df_3T3.columns.difference(['GRO_seq', 'CLASS']))
df_E14_GROseq = df_E14.drop(columns=df_E14.columns.difference(['GRO_seq', 'CLASS']))

X_train_3T3_GROseq, X_test_3T3_GROseq = train_test_split(df_3T3_GROseq, test_size=0.3, shuffle=True)
X_train_E14_GROseq, X_test_E14_GROseq = train_test_split(df_E14_GROseq, test_size=0.3, shuffle=True)

df_3T3_GROseq_RNAseq = df_3T3.drop(columns=df_3T3.columns.difference(['GRO_seq', 'RNA_seq', 'CLASS']))
df_E14_GROseq_RNAseq = df_E14.drop(columns=df_E14.columns.difference(['GRO_seq', 'RNA_seq', 'CLASS']))

X_train_3T3_GROseq_RNAseq, X_test_3T3_GROseq_RNAseq = train_test_split(df_3T3_GROseq_RNAseq, test_size=0.3, shuffle=True)
X_train_E14_GROseq_RNAseq, X_test_E14_GROseq_RNAseq = train_test_split(df_E14_GROseq_RNAseq, test_size=0.3, shuffle=True)

df_3T3_GROseq_RNAseq_DNase = df_3T3.drop(columns=df_3T3.columns.difference(['GRO_seq', 'RNA_seq', 'DNase', 'CLASS']))
df_E14_GROseq_RNAseq_DNase = df_E14.drop(columns=df_E14.columns.difference(['GRO_seq', 'RNA_seq', 'DNase', 'CLASS']))

X_train_3T3_GROseq_RNAseq_DNase, X_test_3T3_GROseq_RNAseq_DNase = train_test_split(df_3T3_GROseq_RNAseq_DNase, test_size=0.3, shuffle=True)
X_train_E14_GROseq_RNAseq_DNase, X_test_E14_GROseq_RNAseq_DNase = train_test_split(df_E14_GROseq_RNAseq_DNase, test_size=0.3, shuffle=True)

df_3T3_GROseq_RNAseq_DNase_H3K4me3 = df_3T3.drop(columns=df_3T3.columns.difference(['GRO_seq', 'RNA_seq', 'DNase', 'H3K4me3', 'CLASS']))
df_E14_GROseq_RNAseq_DNase_H3K4me3 = df_E14.drop(columns=df_E14.columns.difference(['GRO_seq', 'RNA_seq', 'DNase', 'H3K4me3', 'CLASS']))

X_train_3T3_GROseq_RNAseq_DNase_H3K4me3, X_test_3T3_GROseq_RNAseq_DNase_H3K4me3 = train_test_split(df_3T3_GROseq_RNAseq_DNase_H3K4me3, test_size=0.3, shuffle=True)
X_train_E14_GROseq_RNAseq_DNase_H3K4me3, X_test_E14_GROseq_RNAseq_DNase_H3K4me3 = train_test_split(df_E14_GROseq_RNAseq_DNase_H3K4me3, test_size=0.3, shuffle=True)

df_3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3 = df_3T3.drop(columns=df_3T3.columns.difference(['GRO_seq', 'RNA_seq', 'DNase', 'H3K4me3', 'H3K36me3', 'CLASS']))
df_E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3 = df_E14.drop(columns=df_E14.columns.difference(['GRO_seq', 'RNA_seq', 'DNase', 'H3K4me3', 'H3K36me3', 'CLASS']))

X_train_3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3, X_test_3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3 = train_test_split(df_3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3, test_size=0.3, shuffle=True)
X_train_E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3, X_test_E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3 = train_test_split(df_E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3, test_size=0.3, shuffle=True)
...
dataset_pairs = [
    ("E14_to_E14", X_train_E14, X_test_E14),
    ("E14_to_3T3", X_train_E14, X_test_3T3),
    ("3T3_to_E14", X_train_3T3, X_test_E14),
    ("3T3_to_3T3", X_train_3T3, X_test_3T3),
    ("E14_GROseq_to_E14_GROseq", X_train_E14_GROseq, X_test_E14_GROseq),
    ("E14_GROseq_to_3T3_GROseq", X_train_E14_GROseq, X_test_3T3_GROseq),
    ("3T3_GROseq_to_E14_GROseq", X_train_3T3_GROseq, X_test_E14_GROseq),
    ("3T3_GROseq_to_3T3_GROseq", X_train_3T3_GROseq, X_test_3T3_GROseq),
    ("E14_GROseq_RNAseq_to_E14_GROseq_RNAseq", X_train_E14_GROseq_RNAseq, X_test_E14_GROseq_RNAseq),
    ("E14_GROseq_RNAseq_to_3T3_GROseq_RNAseq", X_train_E14_GROseq_RNAseq, X_test_3T3_GROseq_RNAseq),
    ("3T3_GROseq_RNAseq_to_E14_GROseq_RNAseq", X_train_3T3_GROseq_RNAseq, X_test_E14_GROseq_RNAseq),
    ("3T3_GROseq_RNAseq_to_3T3_GROseq_RNAseq", X_train_3T3_GROseq_RNAseq, X_test_3T3_GROseq_RNAseq),
    ("E14_GROseq_RNAseq_DNase_to_E14_GROseq_RNAseq_DNase", X_train_E14_GROseq_RNAseq_DNase, X_test_E14_GROseq_RNAseq_DNase),
    ("E14_GROseq_RNAseq_DNase_to_3T3_GROseq_RNAseq_DNase", X_train_E14_GROseq_RNAseq_DNase, X_test_3T3_GROseq_RNAseq_DNase),
    ("3T3_GROseq_RNAseq_DNase_to_E14_GROseq_RNAseq_DNase", X_train_3T3_GROseq_RNAseq_DNase, X_test_E14_GROseq_RNAseq_DNase),
    ("3T3_GROseq_RNAseq_DNase_to_3T3_GROseq_RNAseq_DNase", X_train_3T3_GROseq_RNAseq_DNase, X_test_3T3_GROseq_RNAseq_DNase),
    ("E14_GROseq_RNAseq_DNase_H3K4me3_to_E14_GROseq_RNAseq_DNase_H3K4me3", X_train_E14_GROseq_RNAseq_DNase_H3K4me3, X_test_E14_GROseq_RNAseq_DNase_H3K4me3),
    ("E14_GROseq_RNAseq_DNase_H3K4me3_to_3T3_GROseq_RNAseq_DNase_H3K4me3", X_train_E14_GROseq_RNAseq_DNase_H3K4me3, X_test_3T3_GROseq_RNAseq_DNase_H3K4me3),
    ("3T3_GROseq_RNAseq_DNase_H3K4me3_to_E14_GROseq_RNAseq_DNase_H3K4me3", X_train_3T3_GROseq_RNAseq_DNase_H3K4me3, X_test_E14_GROseq_RNAseq_DNase_H3K4me3),
    ("3T3_GROseq_RNAseq_DNase_H3K4me3_to_3T3_GROseq_RNAseq_DNase_H3K4me3", X_train_3T3_GROseq_RNAseq_DNase_H3K4me3, X_test_3T3_GROseq_RNAseq_DNase_H3K4me3),
    ("E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3_to_E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3", X_train_E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3, X_test_E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3),
    ("E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3_to_3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3", X_train_E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3, X_test_3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3),
    ("3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3_to_E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3", X_train_3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3, X_test_E14_GROseq_RNAseq_DNase_H3K4me3_H3K36me3),
    ("3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3_to_3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3", X_train_3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3, X_test_3T3_GROseq_RNAseq_DNase_H3K4me3_H3K36me3),
]
...
model_types = ['RF', 'XGB', 'AdaBoost', 'DecisionTree', 'LogReg', 'GBM', 'NaiveBayes', 'MLP', 'KNN']
